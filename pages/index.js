  ...
  return (
    <>
      ...
      <div className="lg:max-h-screen text-center mb-5">
        ...
        <h2 className='lg:w-3/4 mx-auto text-center lg:text-3xl pt-1 tracking-wide text-slate-700 sm:text-2xl md:text-xl'>We position companies for market success and create awareness among their high-value audiences.
        </h2>
      </div>

      <section id='services'>
        <div className='text-center lg:h-[100vh] bg-slate-50'>
          <div className='lg:w-3/4 mx-auto'>
            <h2 className='text-5xl lg:text-5xl pt-16'>Our Services</h2>
      ...
      <div className='text-center container px-5 py-8 mx-auto'>
        ...
        <div className="flex flex-wrap sm:-m-4 pt-8 -mb-10 md:space-y-0 space-y-6">
